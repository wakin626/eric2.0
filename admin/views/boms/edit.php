...
<div class="d-flex justify-content-between mb-4">
    <div class="d-flex gap-2">
        <a href="?controller=admin&action=boms" class="btn btn-outline-secondary"><i class="bi bi-arrow-left me-1"></i>Back to BOMs</a>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-5">
        <div class="card data-card mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="?controller=admin&action=bomUpdate">
...
document.getElementById('saveAddItem').addEventListener('click', function() {
    ...
    fetch('?controller=admin&action=bomAddItem', { method: 'POST', body: formData })
...
document.getElementById('saveEditItem').addEventListener('click', function() {
    ...
    fetch('?controller=admin&action=bomUpdateItem', { method: 'POST', body: formData })
        .then(function(r) { return r.json(); })
        .then(function(data) {
            if (data.success) {
                location.reload();
...
document.querySelectorAll('.remove-bom-item').forEach(function(btn) {
    btn.addEventListener('click', function() {
        ...
        fetch('?controller=admin&action=bomRemoveItem', { method: 'POST', body: formData })
            .then(function(r) { return r.json(); })
            .then(function(data) {
                if (data.success) {
