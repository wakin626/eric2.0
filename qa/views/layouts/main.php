...
<head>
    ...
    <title><?= $page_title ?? 'QA Dashboard' ?></title>
        ...
        <div class="row g-0">
            <nav class="sidebar" id="sidebar">
                <div class="text-center py-3 border-bottom" style="border-color: rgba(255,255,255,0.08) !important">
                    <h5 class="mb-0" style="color: #fff; font-weight: 700; letter-spacing: 0.5px; font-size: 1rem;"><?= ucfirst($_SESSION['department'] ?? 'QA') ?></h5>
                    <small style="color: #64748b; font-size: 0.7rem;"><?= htmlspecialchars($_SESSION['full_name'] ?? '') ?></small>
                </div>
                <ul class="nav flex-column sidebar-menu">
                    <li class="nav-item">
                        <a class="nav-link <?= $page_title == 'QA Dashboard' ? 'active' : '' ?>" href="?controller=qa">
                            <i class="bi bi-speedometer2 me-2"></i>Dashboard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= $page_title == 'Deliveries' ? 'active' : '' ?>" href="?controller=qa&action=delivered">
                            <i class="bi bi-truck me-2"></i>Deliveries
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= $page_title == 'Customer PO' ? 'active' : '' ?>" href="?controller=qa&action=purchaseOrders">
                            <i class="bi bi-cart3 me-2"></i>Customer PO
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= $page_title == 'PO Summary Report' ? 'active' : '' ?>" href="?controller=qa&action=reports">
                            <i class="bi bi-graph-up me-2"></i>PO Summary Report
                        </a>
                    </li>
