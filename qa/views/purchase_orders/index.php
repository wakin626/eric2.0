...
<div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
    <div class="d-flex gap-2 flex-wrap">
        ...
        <select class="form-select form-select-sm" style="width:180px" onchange="location.href='?controller=qa&action=purchaseOrders&delivery_status=' + encodeURIComponent(this.value)">
